                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-semibold text-lg">
                                    {{ $transaction->flight->segments->first()->time->format('d M Y') }}</p>
                            </div>
                            <div class="text-end">
                            ...
                            <div class="flex items-center rounded-[20px] gap-[14px]">
                                ...
                                <div>
                                    <p class="font-bold text-xl leading-[30px]">
                                        {{ Str::ucfirst($transaction->class->class_type) }} Class</p>
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                    {{ $transaction->number_of_passengers }} People</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Tiers</p>
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                    {{ Str::ucfirst($transaction->class->class_type) }}</p>
                            </div>
                            <div>
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                    {{ 'Rp. ' . number_format($transaction->class->price, 0, ',', '.') }}</p>
                            </div>
                            <div>
                            ...
                            <div class="flex items-center gap-[10px]">
                                <div class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                        alt="icon">
                                    <p class="font-semibold">{{ \Carbon\Carbon::parse($passenger->date_of_birth)->format('d')}}</p>
                                </div>
                                <div class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                        alt="icon">
                                    <p class="font-semibold">{{ \Carbon\Carbon::parse($passenger->date_of_birth)->format('m')}}</p>
                                </div>
                                <div class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                        alt="icon">
                                    <p class="font-semibold">{{ \Carbon\Carbon::parse($passenger->date_of_birth)->format('Y')}}</p>
                                </div>
                            </div>
                        </div>
                        <label class="flex flex-col gap-[10px]">
