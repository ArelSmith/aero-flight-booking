                        ...
                        <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                            <label class="flex flex-col gap-[10px]">
                                ...
                                <div
                                    ...
                                    <input type="text" name="passengers[{{ $loop->index }}][name]" id="" value="{{ $passenger['name'] }}"
                                        class="appearance-none outline-none w-full font-semibold placeholder:font-normal"
                                        placeholder="Write your complete name">
                                </div>
                                ...
                                <div class="flex items-center gap-[10px] ">
                                    <label
                                        ...
                                        <select id="day-select-{{ $loop->index }}" data-index={{ $loop->index }}
                                            ...
                                            @for($i = 1; $i <= 31; $i++)
                                                <option value="{{ $i }}" @if(\Carbon\Carbon::parse($passenger['date_of_birth'])->format('d') == $i) selected @endif>
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                    ...
                                    <label
                                        ...
                                        <img src="{{ asset('assets/images/icons/note-add-black.svg') }}"
                                            class="absolute transform -translate-y-1/2 top-1/2 left-5 w-5 shrink-0"
                                            alt="icon">
                                        <select id="month-select-{{ $loop->index }}" data-index={{ $loop->index }}
                                            onchange="updateDateOfBirth({{ $loop->index }})"
                                    ...
                                    <label
                                        ...
                                        <img src="{{ asset('assets/images/icons/note-add-black.svg') }}"
                                            class="absolute transform -translate-y-1/2 top-1/2 left-5 w-5 shrink-0"
                                            alt="icon">
                                        <select id="year-select-{{ $loop->index }}" data-index={{ $loop->index }}
                                            onchange="updateDateOfBirth({{ $loop->index }})"
                            ...
                            <label class="flex flex-col gap-[10px]">
                                ...
                                <div
                                    ...
                                    <select name="passengers[{{ $loop->index }}][nationality]" id=""
                                        ...
                                        <option value="Japan" {{ $passenger['nationality'] === 'Japan' ? 'selected' : '' }}>Japan</option>
                                        <option value="Indonesia" {{ $passenger['nationality'] === 'Indonesia' ? 'selected' : '' }}>Indonesia</option>
                                    </select>
                                </div>
