                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ 'Rp. ' . number_format($tier->price, 2, ',', '.') }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ 'Rp. ' . number_format($tier->price * count($transaction['selected_seats']), 2, ',', '.') }}</p>
                            </div>
                        </div>
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="text-sm text-garuda-grey">Total Tax</p>
                                <p class="font-semibold text-lg leading-[27px] mt-[2px]">{{ 'Rp. ' . number_format($tier->price * count($transaction['selected_seats']) * 0.11, 2, ',', '.') }}</p>
                            </div>
                            <div>
                                <p class="text-sm text-garuda-grey">Grand Total</p>
                                <p class="font-bold text-2xl leading-9 text-garuda-blue mt-[2px]">{{ 'Rp. ' . number_format($tier->price * count($transaction['selected_seats']) * 1.11, 2, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                  ...
                  <div id="Passenger-{{ $loop->index + 1 }}" class="accordion-with-select group flex flex-col h-fit rounded-[20px] bg-white overflow-hidden transition-all duration-300">
                    ...
                    <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <input type="hidden" name="passengers[{{ $loop->index }}][date_of_birth]" id="dateOfBirth-{{ $loop->index }}" date-index="{{ $loop->index }}">
                            <div class="flex items-center gap-[10px]">
                                <label class="relative flex items-center w-full rounded-full overflow-hidden border border-garuda-black gap-[10px] focus-within:border-[#0068FF] transition-all duration-300">
                                    ...
                                    <select data-index={{ $loop->index }} onchange="updateDateOfBirth({{ $loop->index }})" class="date-select day-select appearance-none w-full outline-none pl-[50px] py-3 px-5 font-semibold indeterminate:!font-normal">
